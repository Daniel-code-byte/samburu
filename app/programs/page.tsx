...
import { getPrograms, type Program } from '@/lib/supabase'

export const metadata: Metadata = {
  title: 'Programs — Samburu Mental Health Association',
...
const DEFAULT_PROGRAMS = [
  {
    ...
    points: [
      'Mobile health clinics visiting 12+ villages quarterly',
      'Maternal and child health support',
      'Mental wellness and trauma-informed care',
  ...
  },
  {
    ...
    points: [
      'Girls\' education scholarships and support',
      'Women\'s economic empowerment groups',
      'Safe house and survivor support',
  ...
  },
  {
    ...
    points: [
      ...
      'Sports and arts for wellbeing',
      'Cultural pride and identity programs',
    ],
  },
  {
    id: 'community',
    ...
    points: [
      'Elder care and dignity programs',
    ...
    <>
      ...
      <section className="section-pad">
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '5rem' }}>
          {DEFAULT_PROGRAMS.map((prog, i) => {
            const Icon = prog.icon
            return (
              <div key={prog.id} id={prog.anchor} style={{
                display: 'grid',
                ...
                {i % 2 !== 0 && (
                  <div>
                    <div style={{ padding: '2.5rem', background: prog.bg, borderLeft: `4px solid ${prog.color}` }}>
                      ...
                      <h2 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '2rem', fontWeight: 600, color: 'var(--ink)', marginBottom: '1rem' }}>
                        {prog.title}
                      </h2>
                ...
                <div>
                  {i % 2 === 0 && (
                    <div style={{ padding: '2.5rem', background: prog.bg, borderLeft: `4px solid ${prog.color}`, marginBottom: 0 }}>
                      <div style={{ width: 56, height: 56, background: prog.color + '20', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
                        <Icon size={26} color={prog.color} />
                      </div>
                      <h2 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '2rem', fontWeight: 600, color: 'var(--ink)', marginBottom: '1rem' }}>
                ...
                <div style={{ order: i % 2 === 0 ? 1 : -1 }}>
                  ...
                  <Link href="/contact" className="btn-primary" style={{ marginTop: '2rem', background: prog.color }}>
