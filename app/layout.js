  ...
  return (
    <>
      <nav className="navbar transparent" id="main-navbar">
        ...
        <button className="hamburger" id="hamburger-btn" aria-label="Open menu" aria-expanded="false">
          <span /><span /><span />
        </button>
      </nav>
      ...
      <div className="mobile-menu" id="mobile-menu" aria-hidden="true">
        <button className="mobile-menu-close" id="mobile-menu-close" aria-label="Close menu">✕</button>
        <nav className="mobile-menu-links">
          ...
          <a href="/donate" style={{ color: '#34C270' }}>Donate →</a>
...
function WhatsAppButton() {
  return (
    <a href="https://wa.me/254704579936" target="_blank" rel="noopener noreferrer"
